      ...
      <div className="movie-section">
        <div className="movie-section__card">
          <div className="movie-section__category-title">
            <h3 className="trending">TV Shows</h3>
          </div>
...
export default connect(mapStateToProps, { addToCart, addQuantity, subtractQuantity, emptyCart, removeFromCart })(TvShows)